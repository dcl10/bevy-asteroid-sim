...
/// Determine if a trajectory is elliptical from its eccentricity.
///
/// A trajectory is elliptical if 0 < &epsi; < 1.
///
/// # Arguments
...
/// assert!(!is_elliptical(0f32));
/// assert!(!is_elliptical(1f32));
/// ```
pub fn is_elliptical(eccentricity: f32) -> bool {
    return 0f32 < eccentricity && eccentricity < 1f32;
}

/// Calculate the eccentricity &epsi; of a trajectory around a body.
///
/// # Arguments
...
/// # Examples
/// ```rust
/// assert_eq!(eccentricity(3.0, 5.0), 0.25);
/// ```
pub fn eccentricity(r_min: f32, r_max: f32) -> f32 {
